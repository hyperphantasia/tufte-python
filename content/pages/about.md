...
This port swaps out Ruby, Jekyll, and Liquid for Python, [Jinja2](https://jinja.palletsprojects.com/), and [Python-Markdown](https://python-markdown.github.io/) while keeping the same look and content-authoring [shortcodes](https://hyperphantasia.github.io/tufte-python/articles/2026/tufte-style-jekyll-blog) (sidenotes, margin notes, epigraphs, and so on) the Jekyll version implements.
